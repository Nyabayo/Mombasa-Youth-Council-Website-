    ...
    <>
      <div style={{ backgroundColor: '#003087' }} className="py-10">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-blue-200 text-xs font-bold tracking-widest uppercase mb-2">Get In Touch</p>
          <h1 className="text-white text-3xl sm:text-4xl font-black mb-1">Contact Us</h1>
          <p className="text-blue-200 text-sm">Mombasa Youth Council — We&apos;d love to hear from you</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div style={{ backgroundColor: '#001a52' }} className="rounded-xl p-6 mt-8 text-white">
              ...
              <Link href="/register" style={{ backgroundColor: 'white', color: '#003087' }} className="inline-block px-5 py-2.5 font-bold rounded hover:opacity-90 transition-opacity">
                Join MYC Today
              </Link>
            </div>
          </div>
