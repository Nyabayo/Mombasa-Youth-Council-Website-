    ...
    <>
      <div style={{ backgroundColor: '#003087' }} className="py-10">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-blue-200 text-xs font-bold tracking-widest uppercase mb-2">Programmes</p>
          <h1 className="text-white text-3xl font-black">Leadership Training</h1>
          <p className="text-blue-200 text-sm">In partnership with the Kenya Red Cross</p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="max-w-3xl space-y-5">
          ...
          <p className="text-gray-600 text-sm p-4 rounded" style={{ backgroundColor: '#eff6ff' }}>
