    ...
    <>
      ...
      <div style={{ backgroundColor: '#004B6B' }} className="py-10">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-teal-200 text-sm">Office of the Cabinet Secretary — Mombasa Youth Council (MYC)</p>
        </div>
      </div>
            ...
            <div style={{ backgroundColor: '#004B6B' }} className="overflow-hidden mb-12">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="text-white p-8 flex flex-col justify-center">
                  <p className="text-teal-200 text-xs tracking-widest uppercase font-bold mb-2">Cabinet Secretary</p>
