    ...
    <>
      ...
      <div style={{ backgroundColor: '#003087' }} className="py-10">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-blue-200 text-sm">Deputy President of the Mombasa Youth Council (MYC)</p>
        </div>
      </div>
          ...
          <main className="flex-1 min-w-0">
            ...
            <div style={{ backgroundColor: '#003087' }} className="overflow-hidden mb-12">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="text-white p-8 flex flex-col justify-center">
                  <p className="text-blue-200 text-xs tracking-widest uppercase font-bold mb-2">Her Excellency</p>
            ...
            <section id="leadership-mandate" className="mb-12 scroll-mt-4">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <div className="p-5 border-l-4" style={{ borderColor: '#003087', backgroundColor: '#eff6ff' }}>
