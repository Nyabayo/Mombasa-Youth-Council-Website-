...
export const metadata: Metadata = { title: 'Gallery | News & Media | MYC' }
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="flex items-center gap-2 text-xs text-gray-500 mb-8">
          ...
          <Link href="/news" className="hover:text-blue-700">News</Link><span>/</span>
        ...
        <div className="mt-6 text-center">
          <Link href="/news" className="text-blue-700 hover:underline text-sm font-semibold">← Back to News</Link>
        </div>
      </div>
    </>
  )
