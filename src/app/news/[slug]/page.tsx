  ...
  if (!post) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-20 text-center">
        ...
        <Link href="/news" className="text-blue-700 hover:underline">← Back to News</Link>
      </div>
    )
  }
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <article className="flex-1">
            ...
            <div className="prose prose-gray max-w-none">
              {post.content.split('\n\n').map((para, i) => (
                <p key={i} className="text-gray-800 leading-relaxed mb-4">{para}</p>
              ))}
            </div>
            ...
            <div className="mt-10">
              ...
              {user ? (
                ...
                <div className="mb-8 p-5 bg-blue-50 border border-blue-200 rounded-lg text-center">
                  <p className="text-gray-700 text-sm mb-3">You must be logged in to comment.</p>
          ...
          <aside className="lg:w-56">
            <div className="bg-white border border-gray-200 p-4">
              ...
              <div className="space-y-2">
                <Link href="/news" className="block text-sm text-blue-700 hover:underline">All News →</Link>
