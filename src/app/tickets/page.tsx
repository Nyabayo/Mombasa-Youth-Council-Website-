          ...
          <div className="p-6 space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 px-4 font-black rounded-xl transition-all disabled:opacity-40 flex flex-col items-center justify-center gap-0.5 hover:opacity-90"
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <span className="text-xs font-semibold opacity-70">
                      {ticket.name} &times; {qty} &mdash; KSH {total.toLocaleString()}
                    </span>
                  </>
                )}
              </button>
